...
class QuadrupedController:
    ...
    def __init__(self, robot_id):
        ...
        # 步态参数
        self.stance_height = 0.35  # 站立高度（稍微加高，防止肚皮贴地）
        self.step_height = 0.06    # 抬腿高度
        self.step_length = 0.08    # 步长（不宜过大，否则容易滑倒）
    ...
    def trot_gait(self, t, leg_name, frequency=1.5):
        ...
        if cycle_phase < np.pi:  # 摆动相（腿抬起向前推进）
            ...
            x = self.step_length * (progress - 0.5)  # 从前向后支撑
